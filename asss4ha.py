...
#Fix CPU cores warning
os.environ["LOKY_MAX_CPU_COUNT"] = str(os.cpu_count() or 4)
warnings.filterwarnings("ignore", message="Could not find the number of physical cores")
print(f"Using {os.cpu_count() or 4} logical cores for joblib")

#Config
INPUT_PATH = r"C:\Users\tshab\Downloads\airpoll spreadsheet.xlsx"
SHEET_NAME = 0   # or use sheet name like "Sheet1"
RANDOM_STATE = 42
EXPORT_PATH = r"C:\Users\tshab\Documents\airpoll_kmeans_results.xlsx"
...
print(f"\nExcel results saved to: {final_path}")
